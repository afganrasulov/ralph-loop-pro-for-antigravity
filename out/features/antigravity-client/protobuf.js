...
function buildSafetyConfig(modelName) {
    // Try dynamic registry first, fall back to hardcoded MODEL_IDS
    let modelId;
    try {
        const registry = require("./modelRegistry");
        modelId = registry.getModelId(modelName);
    }
    catch (e) {
        modelId = exports.MODEL_IDS[modelName] || exports.MODEL_IDS["Gemini 3 Flash"];
    }
